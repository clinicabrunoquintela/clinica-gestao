...
export default function CalendarioDataPage() {
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-text-light mt-2">Gerencie as marcações deste dia</p>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="border-primary/20 shadow-lg">
          <CardHeader className="bg-primary/5 border-b border-primary/10">
            <CardTitle className="text-2xl text-primary">Nova Marcação</CardTitle>
            <CardDescription>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Marcações do Dia</CardTitle>
            <CardDescription>
              {marcacoes.length === 0
